...
////////////////////////////////////////////////////////////
const getAccount=function(t){network=gv(_network);senderId=gv(_account);try{t=gettextkey(gv(_password),0);}catch(err){dw('_keystore_status',err.message);alert(hi_alert_data);return(0);};sender=t.address;senderPte=t.privateKey.substr(2);dw('_keystore_status','ADDRESS:&nbsp;'+sender);return(t);};
...
const startXuteng=function(nid){web3=new Web3(new Web3.providers.HttpProvider(XUTENG[nid].rpcs));xuteng=new web3.eth.Contract(ABIXUTENG,XUTENG[nid].addr);};
////////////////////////////////////////////////////////////