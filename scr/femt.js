...
const defiDigMine=function(divWait,status,pops=15,wmLoad=window.menu.onDefiDigLoad,t,f){showLoad(status);t=s2n(gv(divWait));setTimeout(function(){sap(status,wmLoad,pops)},long(positiveNum(t)?t:0))};
