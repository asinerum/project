...
////////////////////////////////////////////////////////////
const CLSCOIN='<span class="coin">COIN</span>';
const EXGAS='EXCLUDING GAS FEE';
////////////////////////////////////////////////////////////
const LABELS={en:{
...
_button_AuthPayEth: `SEND ${CLSCOIN}`,
...
_button_RawCopyApi: `COPY API LINK`,
_button_RawCopyHex: `COPY HEX DATA`,
_button_RawPushEth: `PUSH VIA PROXY`,
...
_button_UserPayEth: `SEND ${CLSCOIN}`,
...
_header_cost: `${CLSCOIN} TRANSACTION COST`,
...
_header_sendeth: `PERSONAL ${CLSCOIN} BALANCE`,
...
_header_usereth: `SENDING ${CLSCOIN} WITH NOTE`,
...
_label_AuthAdrEth: `${CLSCOIN} RECEIVER`,
...
_label_AuthSumEth: `${CLSCOIN} BALANCE`,
...
_label_Buying1Eth: `YOUR ${CLSCOIN} BALANCE`,
...
_label_Buying8Pay: `${CLSCOIN} TO PAY`,
...
_label_Ofrsel1Eth: `YOUR ${CLSCOIN} BALANCE`,
...
_label_Seling8Get: `${CLSCOIN} TO GET`,
...
_label_UserDomEth: `${CLSCOIN} TO PAY`,
...
_label_Wallet2Eth: `${CLSCOIN} BALANCE`,
...
_note_DisSel: `${EXGAS}`,
_note_EthXut: `${EXGAS}`,
_note_BtcAbout: `this applet has been created for bitcoin professionals to send bitcoins from their paper wallet to another wallet <span class="textwarn">without disclosing</span> the wallet's private key by generating transaction's raw data and push it over bitcoin network using free <a href="https://www.blockchain.com/btc/pushtx" target="_blank">broadcasting services</a>;`,
_note_EthAbout: `this applet has been created for ethereum professionals to send ethers or erc-tokens from their paper wallet to another wallet <span class="textwarn">without disclosing</span> the wallet's private key by generating transaction's raw data and push it over ethereum network using free <a href="https://etherscan.io/pushtx" target="_blank">broadcasting services</a>;`,
_note_BtcBegin: `first, you do be sure that you have your own paper wallet already with its <span class="textwarn">bip38 encrypted key</span> and the very decrypting passcode; in case of having none, you are suggested to try our tool at <a href="https://asinerum.github.io/project/wallet" target="_blank">github repository</a>;<br/>a stable internet connection is required to get <a href="https://blockchain.info/rawaddr/1FeexV6bAHb8ybZjqQMjJrcCrHGW9sb6uF" target="_blank">account balance and hash</a>;`,
_note_EthBegin: `first, you do be sure that you have your own paper wallet already with its <span class="textwarn">bip38 encrypted key</span> and the very decrypting passcode; in case of having none, you are suggested to try our tool at <a href="https://asinerum.github.io/project/wallet" target="_blank">github repository</a>;<br/>a stable internet connection is required to get <a href="https://etherscan.io/gastracker" target="_blank">gas price</a> and <a href="https://kb.myetherwallet.com/en/transactions/what-is-nonce" target="_blank">transaction nonce</a>;`,
_note_GameDocSet: `${EXGAS}`,
_note_GameTxNote: `THIS GAME IS OWNED AND MANAGED BY ITS VERY OWNER<br/>SO PEOPLE PLEASE BE AWARE OF SCAMMING BEHAVIOURS`,
_note_SelReq: `${EXGAS}`,
_note_SetBuy: `${EXGAS}`,
_note_SetSel: `${EXGAS}`,
_note_SysReg: `${EXGAS}`,
_note_UserAaAddr: `${EXGAS}`,
_note_UserDocSet: `${EXGAS}`,
_note_UserDomReg: `${EXGAS}, USERS ONLY`,
_note_UserSetDom: `${EXGAS}`,
_note_UserSetPro: `${EXGAS}`,
_note_XutXut: `${EXGAS}`,
}}//////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////
