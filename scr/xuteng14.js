...
const gameSend=function(game=window.txLottoGame,eth='gameeth',bet='gamebet',status='_game_status',t){eth=g2(eth);t=invalids(game,eth,ethnow());if(t)return(dw(status,t));mm_sendeth(game.txAuthor,eth,setInput({ref:game.txh,bet:gv(bet)}),status);};
