...
const startXuteng=function(nid){if(nid){switchNet(nid);window.web3=(new Web3(new Web3.providers.HttpProvider(getRpcNet())));resetXuteng();}else{getProvider();};netStyle();};
////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////
