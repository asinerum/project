...
const xgtUrl='https://paix.asinerum.workers.dev/#a=';
...
;if(nid=='eth-')Object.keys(a).forEach(function(t){if(a[t]&&avalid(a[t].address)){window.ethref={};window.ethref[t]=setInput({ref:a[t].ref});mw(t,'<button\u0020class="axut\u0020bxut"\u0020onclick="mm_sendeth(\''+a[t].address+'\','+a[t].value+',window.ethref[\''+t+'\'],\''+a[t].index+HYPHEN+a[t].address+'\');"\u0020id="'+a[t].index+HYPHEN+a[t].address+'">ETH&nbsp;'+a[t].value+'</button>');}});/**keys**/;
...
const launch=function(mg=200000,gw=0){startXuteng();maxgas=mg;txgwei=gw;btnXut('b','xut-');btnXut('b','eth-');btnXut('b','xga-');btnXut('b','xgt-');btnXut('b','xtx-');};
